...
The Arduino uses a ultrasonic sensor to see if the distance between the driver and the sensor goes too low and whether the driver has fallen asleep or fainted, while also serving as a trigger for the buzzer to wake up the driver.
